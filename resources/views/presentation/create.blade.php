...
‹
            <div class="card-body">
                ...
                <form class="row g-3" action="{{ route('presentation.store', ['entity' => $entity, 'id' => $entityData->id ]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                        <div class="row g-2">
                            <div class="col-md-3 p-2">
                                <div class="form-floating mb-3">
                                    <input class="form-control" type="text" id="presentation_name" name="presentation_name">
                                    <label for="presentation_name">Presentation Name</label>
                                </div>
                            </div>
                            <div class="col-md-3 p-2">
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" id="presentation_date" name="presentation_date" placeholder="">

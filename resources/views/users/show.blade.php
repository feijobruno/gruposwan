        ...
        <div class="card mb-4">
            <div class="card-header hstack gap-2">
                ...
                <span class="ms-auto d-sm-flex flex-row">
                    ...
                    @can('edit-user')
                        <a href="{{ route('user.edit', ['user' => $user->id]) }}" class="btn btn-secondary btn-sm me-1"><i
                    ...
                    @can('edit-user-password')
                        <a href="{{ route('user.edit-password', ['user' => $user->id]) }}"
                            class="btn btn-secondary btn-sm me-1"><i class="fa-solid fa-pen-to-square"></i> Editar Senha
                        </a>
                    @endcan

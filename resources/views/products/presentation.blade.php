    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
          ...
          <ul class="nav nav-tabs pt-2 ps-2 bg-light">
            ...
            <li class="nav-item">
                <a class="nav-link text-decoration-none text-secondary" href="{{ route('product.metting', ['product' => $product]) }}">Reuniones</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active text-decoration-none text-secondary" href="{{ route('product.presentation', ['product' => $product]) }}">Presentaciones</a>
            </li>
          </ul>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="hstack gap-2">
                        <span class="ms-auto">
                            <a href="{{ route('presentation.create', ['entity' => 'product','id' => $product->id]) }}" class="btn btn-primary btn-sm me-3"><i class="fa-solid fa-plus"></i> Añadir</a>
                        </span>
                    </div>
                                ...
                                @forelse ($presentations as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/files/presentation_product/{{ $row->file }}" class="text-decoration-none" download>
                                                @if ($row->file)
                                                    <i
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('presentation.edit', ['entity' => 'product', 'presentation' => $row->id]) }}" class="text-decoration-none"><i class="fa-regular fa-pen-to-square me-2 text-secondary"></i></a>

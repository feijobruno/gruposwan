    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="{{ route('metting.update', ['metting' => $metting->id ]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        <div class="row g-2">
                            <div class="col-md-3 p-2">
                                <div class="form-floating mb-3">
                                    <input class="form-control" type="text" id="metting_name" name="metting_name" value="{{ $metting->metting_name }}">
                                    <label for="metting_name">Metting Name</label>
                                </div>
                            </div>
                            <div class="col-md-3 p-2">
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" id="metting_date" name="metting_date" placeholder="" value="{{ $metting->metting_date }}">

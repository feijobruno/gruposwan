    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
          ...
          <ul class="nav nav-tabs pt-2 ps-2 bg-light">
            ...
            <li class="nav-item">
                <a class="nav-link active text-decoration-none text-secondary" href="{{ route('customer.metting', ['customer' => $customer]) }}">Reuniones</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-decoration-none text-secondary" href="{{ route('customer.presentation', ['customer' => $customer]) }}">Presentaciones</a>
            </li>
          </ul>
                ...
                <div class="row">
                    <div class="hstack gap-2">
                        ...
                        <span class="ms-auto">
                            ...
                            <a href="{{ route('metting.create', ['entity' => 'customer','id' => $customer->id]) }}" class="btn btn-primary btn-sm me-3">
                                ...
                                @forelse ($mettings as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/files/metting_customer/{{ $row->file }}" class="text-decoration-none" download>
                                                @if ($row->file)
                                                    <i
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('metting.edit', ['entity' => 'customer','metting' => $row->id]) }}" class="text-decoration-none"><i class="fa-regular fa-pen-to-square me-2 text-secondary"></i></a>
